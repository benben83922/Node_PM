...
doc_type: "<% tp.system.suggester(['PRD','ERD','Architecture','WBS','API','BDD','ModuleSpec','Sitemap','ClassDiagram','ProjectStructure','Dependencies','Strategy','BusinessPlan','FeatureSpec','Other'], ['PRD','ERD','Architecture','WBS','API','BDD','ModuleSpec','Sitemap','ClassDiagram','ProjectStructure','Dependencies','Strategy','BusinessPlan','FeatureSpec','Other']) %>"
status: draft
phase: planning
priority: medium
owner: PM
